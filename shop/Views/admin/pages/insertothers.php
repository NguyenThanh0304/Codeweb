...
<div id="page-wrapper">
    <div style="width: 80%;border:2px solid black;margin: 0 auto;border-radius: 4px">
        ...
        <form style="width: 90%;margin: 0 auto" method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select id="cbdanhmuc" name="cbdanhmuc" style="width: 20%" class="form-control">
    ...
    <!--CHECK ĐIỀU KIỆN VÀ INSERT XUỐNG DATABASE-->

        <?php 
            if(isset($_POST['submit']) && $_FILES['image']['name'] != null && $_POST['cbdanhmuc'] != null && $_POST['txtname'] != null && $_POST['txtprice'] != null)
            {
                if($_FILES['image']['type'] =="image/jpge" || $_FILES['image']['type'] =="image/png" || $_FILES['image']['type'] =="image/jpg" || $_FILES['image']['type'] =="image/jpeg")
                {
                    if($_FILES['image']['size'] < 3145728)
                    {
                        ...
                        $sql = "INSERT INTO others(idproducts,image,name,price,date) VALUES(".$_POST['cbdanhmuc'].",'".$_FILES['image']['name']."','".$_POST['txtname']."','".$_POST['txtprice']."','".$_POST['txtdate']."')";
