...
<?php foreach ($list as $allothers): ?>
                <tbody>
                     <tr>
                         <td style="width: 05%;text-align: center"><?php echo $allothers['id']?></td>
                         <td style="width: 05%;text-align: center"><?php echo $allothers['idproducts']?></td>
                         <td style="width: 05%;text-align: center"><img src="../../../public/images/<?php echo $allothers['image']?>"  style="width: 25%"></td>
                         <td style="width: 015%;text-align: center"><?php echo $allothers['name']?></td>
                         <td style="width: 05%;text-align: center"><?php echo number_format($allothers['price'])?></td>
                         <td style="width: 025%;text-align: center"><?php echo $allothers['date']?></td>
