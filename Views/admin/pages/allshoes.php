...
<?php foreach ($list as $allshoes): ?>
                <tbody>
                     <tr>
                         <td style="width: 05%;text-align: center"><?php echo $allshoes['id']?></td>
                         <td style="width: 05%;text-align: center"><?php echo $allshoes['idproducts']?></td>
                         <td style="width: 05%;text-align: center"><img src="../../../public/images/<?php echo $allshoes['image']?>"  style="width: 25%"></td>
                         <td style="width: 015%;text-align: center"><?php echo $allshoes['name']?></td>
                         <td style="width: 05%;text-align: center"><?php echo number_format($allshoes['price'])?></td>
                         <td style="width: 025%;text-align: center"><?php echo $allshoes['date']?></td>
