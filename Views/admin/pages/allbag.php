...
<?php foreach ($list as $allbag): ?>
                <tbody>
                     <tr>
                         <td style="width: 05%;text-align: center"><?php echo $allbag['id']?></td>
                         <td style="width: 05%;text-align: center"><?php echo $allbag['idproducts']?></td>
                         <td style="width: 05%;text-align: center"><img src="../../../public/images/<?php echo $allbag['image']?>"  style="width: 25%"></td>
                         <td style="width: 015%;text-align: center"><?php echo $allbag['name']?></td>
                         <td style="width: 05%;text-align: center"><?php echo number_format($allbag['price'])?></td>
                         <td style="width: 025%;text-align: center"><?php echo $allbag['date']?></td>
